...
const SearchBar:React.FC<SearchProps> = ({}) => {
    return (
        <form action="#" className="flex flex-1 items-center h-[42px] ml-10 brightness-95 bg-color rounded-lg pl-4">
            <button type="submit">
            ...
            <input className="w-full h-full bg-transparent outline-none pl-4 font-thin searchbar" type="search" name="search" id="search" placeholder="Search by Inspiration" />
        </form>
    )
}
