...
const SearchForm :React.FC<SearchFormProps> = ({}) => {
    return (
        <div className="search-form relative flex items-center text-sm">
            <div className="search-form__field flex flex-1 h-full">
                ...
                <input type="text" className="search-form__input relative flex-1 h-full text-sm" placeholder="Search in Inspiration" />
            </div>
